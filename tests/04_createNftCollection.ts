...
describe("Create NFT Collection", () => {
  ...
  it("Admin successfully create Energy NFT Collection", async () => {
    ...
    const [metadata] = anchor.web3.PublicKey.findProgramAddressSync(
      [Buffer.from("metadata"), metadata_pubkey.toBuffer(), minter.toBuffer()],
      metadata_pubkey
    );
  ...
  it("Mint an nft", async () => {
    ...
    const [shield_minter] = anchor.web3.PublicKey.findProgramAddressSync(
      [Buffer.from("BattleBoosters"), Buffer.from("mint"), Buffer.from([1])],
      program.programId
    );
    ...
    const [points_minter] = anchor.web3.PublicKey.findProgramAddressSync(
      [Buffer.from("BattleBoosters"), Buffer.from("mint"), Buffer.from([2])],
      program.programId
    );
    ...
    const [fighter_minter] = anchor.web3.PublicKey.findProgramAddressSync(
      [Buffer.from("BattleBoosters"), Buffer.from("mint"), Buffer.from([3])],
      program.programId
    );
